...
public class Singleton_Notes_Details {
    ...
    The constant is returned through a public static method
    By marking the constructor private, we are making the class implicitly final - i.e. it cannot be subclassed

    Every class which is subclass of a parent class has super() as first line in the constructor
    to call the constructor of the parent which in this case would not be possible because the
    constructor of the parent class - i.e. our class will be  private - This is called effectively final
